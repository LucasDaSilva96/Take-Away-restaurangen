...
const Cartoverlay = () => {
  // States from zustand
  const { cart, clearCart, total, amount, menuOpen, toggleMenu } = useCart();
              ...
              >
                ...
                <section className="w-full flex justify-center">
                  <ButtonBase
                    text="Close Cart"
                    onClick={toggleOpen}
                    classname="text-main-secondary border-2 border-main-secondary hover:text-main-light hover:bg-main-secondary transition-all duration-300"
                  />
                </section>
              </motion.section>
            </motion.section>
