...
const Nav = () => {
  ...
  //Fetch functions from Zustand to use globaly
  ...
  //Render correct nav version depending on route.
  useEffect(() => {
  ...
  //Get user by JWT if signed in and update in states. Runs on route change
  ...
  const links = [
    ...
    { name: "Order status", href: "/orderhandle" },
  ];
              ...
              >
                ...
                >
                  <Link href={"/menu"}>
                    <ButtonBase
                      text="Order now"
                      classname="bg-main-light text-main-primary
                       hover:scale-105 transition-all text-nowrap ease-in-out duration-300"
                    />
                  </Link>

                  {/* Authbutton, tracks user auth status and renders different buttons accordingly */}
                  <Authbutton
                    closeModal={toggleNav}
                    classname="bg-main-primary text-main-light hover:scale-105 transition-all text-nowrap ease-in-out duration-300"
                  />
                </motion.section>
              </motion.section>
            </motion.section>
