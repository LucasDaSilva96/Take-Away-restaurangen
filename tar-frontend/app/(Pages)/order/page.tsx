...
const Page = () => {
  ...
  return (
    <>
      <section
        className={
          "w-screen min-h-screen lg:h-screen bg-main-light flex flex-col justify-center items-center gap-2 my-40 lg:my-0"
        }
      >
        <section
          className={
            "w-full flex flex-col lg:flex-row lg:justify-center lg:items-center gap-2 p-4"
          }
        >
          <section>
          ...
          <section
            className={
              "bg-slate-100 p-4 rounded h-full flex justify-center items-center"
            }
          >
            {cart.length > 0 ? (
      ...
      {applePay && <Paymentpopup toggle={() => setApplePay(!applePay)} />}
    </>
  );
};
export default Page;
