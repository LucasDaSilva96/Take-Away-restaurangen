...
const Page = () => {
    ...
    return (
        <section className={"w-screen min-h-screen bg-main-light flex flex-col justify-center items-center gap-2 my-40"}>
            ...
            <section className={"w-full flex flex-col gap-2 p-4"}>
                ...
                <section className={"w-full"}>
                    ...
                    {signedIn && user ?<section className={"w-full"}>
                        ...
                        <Link href={"/signin"} >
                            <ButtonBase text={"Sign in to track and modify order"} classname={"bg-main-primary"} />
                        </Link>
                ...
                {cart.length > 0 ? <section className={"w-full flex flex-col gap-2"}>
                    ...
                    <section className={"w-full flex justify-between items-center"}>
                        <ButtonBase text={`Confirm and pay`} classname={"bg-main-primary"}/>
                    ...
                    <p className={"font-motter text-main-primary text-center"}>Cart empty. Please add something from the menu!</p>
                    <Link href={"/menu"}>
